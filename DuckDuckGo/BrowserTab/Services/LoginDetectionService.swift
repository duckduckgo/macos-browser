...
final class LoginDetectionService {
    ...
    /// The login attempt was discarded, clear any stated associated with it (e.g. credentials).
    private var loginDiscardedHandler: () -> Void
    ...
    init(loginDiscardedHandler: @escaping () -> Void, loginDetectionHandler: @escaping (String) -> Void) {
        self.loginDiscardedHandler = loginDiscardedHandler
