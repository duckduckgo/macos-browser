...
extension UserText {
    ...
    static let networkProtectionInviteDialogTitle = NSLocalizedString("network.protection.invite.dialog.title", value: "You've unlocked a feature!", comment: "Title for the network protection invite dialog")
