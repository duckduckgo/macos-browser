...
extension UserText {
    ...
    // "network.protection.invite.success.title" - Title for the network protection invite success view
    ...
    // "network.protection.configuration.system-settings.legacy" - Text for a label in the Network Protection popover, displayed after attempting to enable Network Protection for the first time while using macOS 12 and below
    private static let networkProtectionSystemSettingsLegacy = "Go to Security & Privacy in System Preferences to allow Network Protection to activate"
    // "network.protection.configuration.system-settings.modern" - Text for a label in the Network Protection popover, displayed after attempting to enable Network Protection for the first time while using macOS 13 and above
    private static let networkProtectionSystemSettingsModern = "Go to Privacy & Security in System Settings to allow Network Protection to activate"
    ...
    static let networkProtectionPleaseReboot = "Please reboot to activate Network Protection"
}
...
extension UserText {
    ...
    // "network-protection.waitlist.notification.title" - Title for Network Protection waitlist notification
    static let networkProtectionWaitlistNotificationTitle = "Network Protection beta is ready!"
    // "network-protection.waitlist.notification.text" - Title for Network Protection waitlist notification
    static let networkProtectionWaitlistNotificationText = "Open your invite"

    // "network-protection.waitlist.join.title" - Title for Network Protection join waitlist screen
    static let networkProtectionWaitlistJoinTitle = "Network Protection Beta"
    // "network-protection.waitlist.join.subtitle.1" - First subtitle for Network Protection join waitlist screen
    static let networkProtectionWaitlistJoinSubtitle1 = "Secure your connection anytime, anywhere with Network Protection, the VPN from DuckDuckGo."
    // "network-protection.waitlist.join.subtitle.2" - Second subtitle for Network Protection join waitlist screen
    static let networkProtectionWaitlistJoinSubtitle2 = "Join the waitlist, and we’ll notify you when it’s your turn."

    // "network-protection.waitlist.joined.title" - Title for Network Protection joined waitlist screen
    static let networkProtectionWaitlistJoinedTitle = "You’re on the list!"
    // "network-protection.waitlist.joined.with-notifications.subtitle.1" - Subtitle 1 for Network Protection joined waitlist screen when notifications are enabled
    ...
    // "network-protection.waitlist.joined.with-notifications.subtitle.2" - Subtitle 2 for Network Protection joined waitlist screen when notifications are enabled
    static let networkProtectionWaitlistJoinedWithNotificationsSubtitle2 = "We’ll notify you when your invite is ready."
    // "network-protection.waitlist.enable-notifications" - Enable notifications prompt for Network Protection joined waitlist screen
    static let networkProtectionWaitlistEnableNotifications = "Want to get a notification when your Network Protection invite is ready?"

    // "network-protection.waitlist.invited.title" - Title for Network Protection invited screen
    static let networkProtectionWaitlistInvitedTitle = "You’re invited to try\nNetwork Protection beta!"
    // "network-protection.waitlist.invited.subtitle" - Subtitle for Network Protection invited screen
    ...
    // "network-protection.waitlist.invited.section-1.title" - Title for section 1 of the Network Protection invited screen
    static let networkProtectionWaitlistInvitedSection1Title = "Full-device coverage"
    // "network-protection.waitlist.invited.section-1.subtitle" - Subtitle for section 1 of the Network Protection invited screen
    static let networkProtectionWaitlistInvitedSection1Subtitle = "Encrypt online traffic across your browsers and apps."

    // "network-protection.waitlist.invited.section-2.title" - Title for section 2 of the Network Protection invited screen
    static let networkProtectionWaitlistInvitedSection2Title = "Fast, reliable, and easy to use"
    // "network-protection.waitlist.invited.section-2.subtitle" - Subtitle for section 2 of the Network Protection invited screen
    ...
    // "network-protection.waitlist.invited.section-3.title" - Title for section 3 of the Network Protection invited screen
    static let networkProtectionWaitlistInvitedSection3Title = "Strict no-logging policy"
    // "network-protection.waitlist.invited.section-3.subtitle" - Subtitle for section 3 of the Network Protection invited screen
    ...
    // "network-protection.waitlist.enable.title" - Title for Network Protection enable screen
    static let networkProtectionWaitlistEnableTitle = "Ready to enable Network Protection?"
    // "network-protection.waitlist.enable.subtitle" - Subtitle for Network Protection enable screen
    ...
    // "network-protection.waitlist.availability-disclaimer" - Availability disclaimer for Network Protection join waitlist screen
    static let networkProtectionWaitlistAvailabilityDisclaimer = "Network Protection is free to use during the beta."

    // "network-protection.waitlist.button.close" - Close button for Network Protection join waitlist screen
    static let networkProtectionWaitlistButtonClose = "Close"
    // "network-protection.waitlist.button.done" - Close button for Network Protection joined waitlist screen
    static let networkProtectionWaitlistButtonDone = "Done"
    // "network-protection.waitlist.button.dismiss" - Dismiss button for Network Protection join waitlist screen
    static let networkProtectionWaitlistButtonDismiss = "Dismiss"
    // "network-protection.waitlist.button.cancel" - Cancel button for Network Protection join waitlist screen
    static let networkProtectionWaitlistButtonCancel = "Cancel"
    // "network-protection.waitlist.button.no-thanks" - No Thanks button for Network Protection joined waitlist screen
    static let networkProtectionWaitlistButtonNoThanks = "No Thanks"
    // "network-protection.waitlist.button.get-started" - Get Started button for Network Protection joined waitlist screen
    static let networkProtectionWaitlistButtonGetStarted = "Get Started"
    // "network-protection.waitlist.button.got-it" - Got It button for Network Protection joined waitlist screen
    static let networkProtectionWaitlistButtonGotIt = "Got It"
    // "network-protection.waitlist.button.enable-notifications" - Enable Notifications button for Network Protection joined waitlist screen
    static let networkProtectionWaitlistButtonEnableNotifications = "Enable Notifications"
    // "network-protection.waitlist.button.join-waitlist" - Join Waitlist button for Network Protection join waitlist screen
    static let networkProtectionWaitlistButtonJoinWaitlist = "Join the Waitlist"
    // "network-protection.waitlist.button.agree-and-continue" - Agree and Continue button for Network Protection join waitlist screen
...
extension UserText {
    ...
    // "network-protection.privacy-policy.title" - Privacy Policy title for Network Protection
    static let networkProtectionPrivacyPolicyTitle = "Privacy Policy"

    // "network-protection.privacy-policy.section.1.title" - Privacy Policy title for Network Protection
    ...
    // "network-protection.privacy-policy.section.1.list" - Privacy Policy list for Network Protection (Markdown version)
    ...
    // "network-protection.privacy-policy.section.1.list" - Privacy Policy list for Network Protection (Non-Markdown version)
    ...
    // "network-protection.privacy-policy.section.2.title" - Privacy Policy title for Network Protection
    static let networkProtectionPrivacyPolicySection2Title = "We don’t keep any logs of your online activity."
    // "network-protection.privacy-policy.section.2.list" - Privacy Policy list for Network Protection
    ...
    // "network-protection.privacy-policy.section.3.title" - Privacy Policy title for Network Protection
    ...
    // "network-protection.privacy-policy.section.3.list" - Privacy Policy list for Network Protection
    ...
    // "network-protection.privacy-policy.section.4.title" - Privacy Policy title for Network Protection
    static let networkProtectionPrivacyPolicySection4Title = "We use dedicated servers for all VPN traffic."
    // "network-protection.privacy-policy.section.4.list" - Privacy Policy list for Network Protection
    ...
    // "network-protection.privacy-policy.section.5.title" - Privacy Policy title for Network Protection
    ...
    // "network-protection.privacy-policy.section.5.list" - Privacy Policy list for Network Protection
    ...
    // "network-protection.terms-of-service.title" - Terms of Service title for Network Protection
    static let networkProtectionTermsOfServiceTitle = "Terms of Service"

    // "network-protection.terms-of-service.section.1.title" - Terms of Service title for Network Protection
    static let networkProtectionTermsOfServiceSection1Title = "The service is for limited and personal use only."
    // "network-protection.terms-of-service.section.1.list" - Terms of Service list for Network Protection
    ...
    // "network-protection.terms-of-service.section.2.title" - Terms of Service title for Network Protection
    ...
    // "network-protection.terms-of-service.section.2.list" - Terms of Service list for Network Protection (Markdown version)
    ...
    // "network-protection.terms-of-service.section.2.list" - Terms of Service list for Network Protection (Non-Markdown version)
    ...
    // "network-protection.terms-of-service.section.3.title" - Terms of Service title for Network Protection
    static let networkProtectionTermsOfServiceSection3Title = "You must be eligible to use this service."
    // "network-protection.terms-of-service.section.3.list" - Terms of Service list for Network Protection
    ...
    // "network-protection.terms-of-service.section.4.title" - Terms of Service title for Network Protection
    static let networkProtectionTermsOfServiceSection4Title = "We provide this beta service as-is and without warranty."
    // "network-protection.terms-of-service.section.4.list" - Terms of Service list for Network Protection
    ...
    // "network-protection.terms-of-service.section.5.title" - Terms of Service title for Network Protection
    static let networkProtectionTermsOfServiceSection5Title = "We may terminate access at any time."
    // "network-protection.terms-of-service.section.5.list" - Terms of Service list for Network Protection
    ...
    // "network-protection.terms-of-service.section.6.title" - Terms of Service title for Network Protection
    static let networkProtectionTermsOfServiceSection6Title = "The service is free during the beta period."
    // "network-protection.terms-of-service.section.6.list" - Terms of Service list for Network Protection
    ...
    // "network-protection.terms-of-service.section.7.title" - Terms of Service title for Network Protection
    static let networkProtectionTermsOfServiceSection7Title = "We are continually updating the service."
    // "network-protection.terms-of-service.section.7.list" - Terms of Service list for Network Protection
    ...
    // "network-protection.terms-of-service.section.8.title" - Terms of Service title for Network Protection
    static let networkProtectionTermsOfServiceSection8Title = "We need your feedback."
    // "network-protection.terms-of-service.section.8.list" - Terms of Service list for Network Protection
