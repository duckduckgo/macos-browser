...
struct UserText {
    ...
    static let selectedDomainsDescription = NSLocalizedString("fire.selected-domains.description", value: "Clear website data only for selected domains", comment: "Description of the 'Current Window' configuration option for the fire button")
