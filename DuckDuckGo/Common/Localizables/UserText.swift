...
struct UserText {
    ...
    static let openLinkInNewWindow = NSLocalizedString("open.link.in.new.window", value: "Open Link in New Window", comment: "Context menu item")
    static let downloadLinkedFile = NSLocalizedString("download.linked.file", value: "Download Linked File", comment: "Context menu item")
    static let copyLink = NSLocalizedString("Copy Link", value: "Copy Link", comment: "Context menu item")
    ...
    static let openImageInNewWindow = NSLocalizedString("open.image.in.new.window", value: "Open Image in New Window", comment: "Context menu item")
    static let saveImageToDownloads = NSLocalizedString("save.image.to.downloads", value: "Save Image to \"Downloads\"", comment: "Context menu item - \"Downloads\" is a common folder name, do not translate it")
    static let copyImageAddress = NSLocalizedString("copy.image.address", value: "Copy Image Address", comment: "Context menu item")
    static let copyImage = NSLocalizedString("Copy Image", value: "Copy Image", comment: "Context menu item")
