...
// TODO: Done till here
    ...
    static let sslErrorAdvancedInfoBody = NSLocalizedString("ssl.error.page.advanced.info.body", value: "It’s possible that the website is misconfigured or that an attacker has compromised your connection.", comment: "Body of the text of the Advanced info shown in an error page that warns users of security risks on a website due to SSL issues.")
    ...
    static func sslErrorCertificateWrongHostMessage(_ domain: String) -> String {
        let localized = NSLocalizedString("ssl.error.wrong.host.message",
                                          value: "The security certificate for %1$@ does not match *.%1$@.",
    ...
    static func sslErrorCertificateSelfSignedMessage(_ domain: String) -> String {
        let localized = NSLocalizedString("ssl.error.self.signed.message",
                                          value: "The security certificate for %1$@ is not trusted by your computer's operating system.",
