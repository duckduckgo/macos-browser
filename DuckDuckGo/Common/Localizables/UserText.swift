...
// TODO: Done till here
    ...
    static let privacyProtections = NSLocalizedString("preferences.privacy-protections", value: "Privacy Protections", comment: "Section header in Preferences for privacy protections")
    ...
    static let preferencesOn = NSLocalizedString("preferences.on", value: "On", comment: "Status indicator of a privacy protection.")
    ...
    static let webTrackingProtection = NSLocalizedString("preferences.web-tracking-protection", value: "Web Tracking Protection", comment: "Show Web Tracking Protection preferences")
    static let emailProtectionPreferences = NSLocalizedString("preferences.email-protection", value: "Email Protection", comment: "Show Email Protection preferences")
