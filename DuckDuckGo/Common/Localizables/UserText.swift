...
// TODO: Done till here
    ...
    static let newTabPrivacyStatsSectionTitle = NSLocalizedString("newTab.privacy.stats.section.title", value: "Privacy Stats", comment: "Title of the Privacy Stats section in the home page")
