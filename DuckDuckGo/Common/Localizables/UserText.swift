...
// TODO: Done till here
    ...
    static let phishingErrorPageTabTitle = NSLocalizedString("phishing.error.page.tab.title", value: "Warning: This site puts your personal information at risk", comment: "Title shown in an error page tab that warn users of security risks on a website due to Phishing issues")
    static func phishingErrorPageBody(_ domain: String) -> String {
        let localized = NSLocalizedString("phishing.error.page.body",
                                          value: "This website may be impersonating a legitimate site in order to trick you into providing personal information, such as passwords or credit card numbers.",
    ...
    static let phishingErrorAdvancedInfoBodyPhishing = NSLocalizedString("phishing.error.page.advanced.info.body.credential.phishing", value: "Warnings are shown for websites that have been reported to be deceptive. Deceptive websites try to trick you into believing they are legitimate websites you trust. If you understand the risks involved, you can continue anyway.<br><br>See our Phishing and Malware Protection help page for more information.", comment: "Body of the text of the Advanced info shown in an error page that warns users of security risks on a website due to Phishing issues.")
    static let phishingErrorSpecificMessage = NSLocalizedString("phishing.error.page.specific.message.phishing", value: "", comment: "Specific message shown in an error page that warns users of security risks on a website due to Phishing issues.")
    static let phishingErrorLearnMoreURL = NSLocalizedString("phishing.error.page.learn.more.url", value: "https://duckduckgo.com/duckduckgo-help-pages/", comment: "URL of help page with in-depth description of the error")
