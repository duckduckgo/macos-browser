...
// TODO: Done till here
    ...
    static let onboardingStartBrowsingText = NSLocalizedString("onboarding.startbrowsing.text", value: """
    You’re all set!
    ...
    """, comment: "Call to action to start using the app as a browser. There should be a non-breaking space (0x00A0 – ” “) between “possible” and “🔒”")
