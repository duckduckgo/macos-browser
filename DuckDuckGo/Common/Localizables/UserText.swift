...
struct UserText {
    ...
    static let allDataDescription = NSLocalizedString("fire.all-data.description", value: "Close all tabs and clear site data", comment: "Description of the 'All Data' configuration option for the fire button")
    ...
    static let currentWindowDescription = NSLocalizedString("fire.current-window.description", value: "Close current window and clear related site data", comment: "Description of the 'Current Window' configuration option for the fire button")
