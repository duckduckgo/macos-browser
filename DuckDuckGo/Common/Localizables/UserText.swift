...
// TODO: Done till here
    ...
    static let setAsDefaultBrowser = NSLocalizedString("preferences.set-as-default", value: "Make DuckDuckGo Your Default", comment: "Menu option to set the browser as default")
