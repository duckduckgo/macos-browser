...
struct UserText {
    ...
    static let syncRecoveryCodeFileName = NSLocalizedString("sync.recovery-code-file-name", value: "Sync Data Recovery - DuckDuckGo", comment: "Name of the sync recovery code pdf file")
