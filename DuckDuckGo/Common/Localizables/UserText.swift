...
struct UserText {
    ...
    static let autolockLocksFormFill = NSLocalizedString("autofill.autolock-locks-form-filling", value: "Also lock acesss to username, password and credit card form fill.", comment: "Lock form filling when auto-lock is active text")
