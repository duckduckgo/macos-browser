...
struct UserText {
    ...
    static let autofillNeverLockWarning = NSLocalizedString("autofill.never-lock-warning", value: "If not locked, anyone with access to your device will be able to use and modify your Autofill data. For your safety, filling in Credit Cards is always locked.", comment: "Autofill disabled auto-lock warning")
