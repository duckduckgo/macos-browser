...
struct UserText {
    ...
    static let autofillNeverLockWarning = NSLocalizedString("autofill.never-lock-warning", value: "Anyone with access to your device will be able to use and modify your Autofill data if not locked. For your safety, filling in Credit Cards is always locked.", comment: "Autofill disabled auto-lock warning")
    static let autolockLocksFormFill = NSLocalizedString("autofill.autolock-locks-form-filling", value: "Also lock filling in login forms.", comment: "Lock form filling when auto-lock is active text")
