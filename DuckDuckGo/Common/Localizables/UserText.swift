...
// TODO: Done till here
    ...
    static let newerCriticalUpdateAvailable = NSLocalizedString("settings.newer.critical.update.available", value: "Critical update available", comment: "Label informing users the critical update of the app is available to install.")
