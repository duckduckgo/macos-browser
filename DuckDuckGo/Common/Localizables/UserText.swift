...
//    static let importBrowserData = NSLocalizedString("import.browser.data", value: "Import Bookmarks and Passwords…", comment: "Opens Import Browser Data dialog")
    ...
    static let newTabContentSettingTitle = NSLocalizedString("preferences.appearance.new-tab", value: "New Tab Content", comment: "New Tab Content settings section title")
    static let showNextSteps = NSLocalizedString("preferences.appearance.show-next-steps", value: "Show Next Steps", comment: "Option to show Next Steps section")
    static let showFavorites = NSLocalizedString("preferences.appearance.show-favorites", value: "Show Favorites", comment: "Option to show Favorite section")
    static let showRecentActivity = NSLocalizedString("preferences.appearance.show-recent-activity", value: "Show Recent Activity", comment: "Option to show Recent Activity section")
