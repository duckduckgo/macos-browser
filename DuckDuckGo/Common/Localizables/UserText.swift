...
struct UserText {
    ...
    static let showNetworkProtectionShortcut = NSLocalizedString("pinning.show-netp-shortcut", value: "Show Network Protection shortcut", comment: "Menu item for showing the NetP shortcut")
    static let hideNetworkProtectionShortcut = NSLocalizedString("pinning.hide-netp-shortcut", value: "Hide Network Protection shortcut", comment: "Menu item for hiding the NetP shortcut")
