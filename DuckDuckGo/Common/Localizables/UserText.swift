...
// TODO: Done till here
    ...
    static func phishingErrorPageBody(_ domain: String) -> String {
        let localized = NSLocalizedString("phishing.error.page.body",
                                          value: "This website may be impersonating a legitimate site in order to trick you into providing personal information, such as passwords or credit card numbers. <a class=\"learn-more\" href=\"https://duckduckgo.com/duckduckgo-help-pages/\" target=\"_blank\">Learn more</a>",
