...
struct UserText {
    ...
    static let restoreWindowsAndTabs = NSLocalizedString("preferences.open-windows-and-tabs", value: "Restore windows and tabs from previous session", comment: "Option to control session restoration")
