...
enum ConfigurationLocation: String, CaseIterable {
    ...
    case FBConfig = "https://staticcdn.duckduckgo.com/useragents/" // In archived repo, to be refactored shortly (https://staticcdn.duckduckgo.com/useragents/social_ctp_configuration.json)
