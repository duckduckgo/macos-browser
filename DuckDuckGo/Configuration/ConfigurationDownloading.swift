...
enum ConfigurationLocation: String, CaseIterable {
    ...
    case trackerRadar = "https://staticcdn.duckduckgo.com/trackerblocking/v3/apple-tds.json"
    case privacyConfiguration = "https://raw.githubusercontent.com/duckduckgo/privacy-configuration/dharb/element-hiding-test/generated/v2/macos-config.json"
