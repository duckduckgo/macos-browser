...
//     }
     ...
     const entities = []
     const ddgFont = "" //TODO chrome.runtime.getURL('public/font/ProximaNova-Reg-webfont.woff')
     const ddgFontBold = ""//TODO  chrome.runtime.getURL('public/font/ProximaNova-Bold-webfont.woff2')
     const entityData = {}
     ...
     **/
     ...
     function b64EncodeSurrogate(sur) {
         ...
         return b64dataheader + b64surrogate
     }

     function loadSurrogate(surrogate) {
     ...
     function init () {
         const fbSurrogateB64 = b64EncodeSurrogate(fbSurrogate)
         loadSurrogate(fbSurrogateB64)

         for (const entity of Object.keys(fbConfig)) {
             entities.push(entity)
             entityData[entity] = {
                 shouldShowLoginModal: true,
                 modalIcon: fbConfig[entity].informationalModal.icon,
                 modalTitle: fbConfig[entity].informationalModal.messageTitle,
                 modalText: fbConfig[entity].informationalModal.messageBody,
                 modalAcceptText: fbConfig[entity].informationalModal.confirmButtonText,
                 modalRejectText: fbConfig[entity].informationalModal.rejectButtonText,
                 simpleVersion: fbConfig[entity].simpleVersion
             }
         }
         replaceClickToLoadElements(fbConfig)
     }
