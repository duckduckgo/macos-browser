...
final class MainMenuManager {
    ...
    guard let menu = NSApplication.shared.mainMenu,
          let helpMenuItemSubmenu = menu.helpMenuItem?.submenu,
          let helpSeparatorMenuItem = menu.helpSeparatorMenuItem,
          let sendFeedbackMenuItem = menu.sendFeedbackMenuItem else {
