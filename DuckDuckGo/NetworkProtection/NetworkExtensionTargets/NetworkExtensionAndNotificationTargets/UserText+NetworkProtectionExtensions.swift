...
final class UserText {
    ...
    static let networkProtectionSupersededNotificationTitle = NSLocalizedString("network.protection.superceded.notification.title", value: "DuckDuckGo VPN is disabled", comment: "The title of the notification shown when VPN connection is replaced by another app VPN connection taking over")
