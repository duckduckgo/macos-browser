...
//        switch step {
//        case .begin:
//            os_log("🔵 \(, privacy: .public) attempt begins", log: log, name)
//        case .failure(let error):
//            os_log("🔴 \(, privacy: .public) attempt failed with error: \(, privacy: .public)", log: log, type: .error, name, error.localizedDescription)
//        case .success:
//            os_log("🟢 \(, privacy: .public) attempt succeeded", log: log, name)
//        }
//    }
//
...
//            os_log("🔴 Connection tester (\(, privacy: .public) - \(, privacy: .public)) failure", log: log, type: .error, duration.rawValue, server)
//        case .recovered(let duration, let failureCount):
//            os_log("🟢 Connection tester (\(, privacy: .public) - \(, privacy: .public)) recovery (after \(, privacy: .public) failures)", log: log, duration.rawValue, server, String(failureCount))
//        }
//    }
//
...
//            os_log("🔴 Failure Recovery attempt failed with error: \(, privacy: .public)", log: log, type: .error, error.localizedDescription)
...
//            os_log("Connection quality is: \(, privacy: .public)", log: log, quality.rawValue)
//        }
//    }
//}
