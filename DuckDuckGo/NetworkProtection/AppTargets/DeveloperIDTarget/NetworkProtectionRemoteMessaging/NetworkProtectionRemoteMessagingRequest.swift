...
final class DefaultNetworkProtectionRemoteMessagingRequest: NetworkProtectionRemoteMessagingRequest {
    ...
    enum Endpoint {
        ...
        var url: URL {
            switch self {
            case .debug: return URL(string: "http://staticcdn.duckduckgo.com/macos-desktop-browser/network-protection/messages-debug.json")!
            case .production: return URL(string: "http://staticcdn.duckduckgo.com/macos-desktop-browser/network-protection/messages.json")!
            }
        }
    }
