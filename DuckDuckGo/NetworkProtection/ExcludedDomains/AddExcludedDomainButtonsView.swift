//
//  AddExcludedDomainButtonsView.swift
//
...
struct AddExcludedDomainButtonsView: View {
    ...
    var body: some View {
        HStack {
            ...
            actionButton(action: otherButtonAction, viewState: viewState).accessibilityIdentifier("AddExcludedDomainButtonsView.otherButton")

            actionButton(action: defaultButtonAction, viewState: viewState).accessibilityIdentifier("AddExcludedDomainButtonsView.defaultButton")
        }
    }
...
extension AddExcludedDomainButtonsView {
