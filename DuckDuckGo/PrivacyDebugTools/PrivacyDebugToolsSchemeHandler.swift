//
//  PrivacyDebugToolsSchemeHandler.swift
//
...
final class PrivacyDebugToolsSchemeHandler: NSObject, WKURLSchemeHandler {
    ...
    func response(for url: URL) -> (URLResponse, Data)? {
        ...
        var directoryURL = URL(fileURLWithPath: "/pages/debug-tools")
