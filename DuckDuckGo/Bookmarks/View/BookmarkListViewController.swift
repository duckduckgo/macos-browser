...
final class BookmarkListViewController: NSViewController {
    ...
    private lazy var dataSource = BookmarkOutlineViewDataSource(contentMode: .bookmarksAndFolders, treeController: treeController)
    ...
    @IBAction
    func newBookmarkButtonClicked(_: AnyObject) {
    ...
    @IBAction
    func newFolderButtonClicked(_: AnyObject) {
    ...
    @IBAction
    func openManagementInterface(_: NSButton) {
    ...
    @IBAction
    func handleClick(_ sender: NSOutlineView) {
...
extension BookmarkListViewController: BookmarkMenuItemSelectors {
    ...
    func editBookmark(_: NSMenuItem) {
...
extension BookmarkListPopover: BookmarkListViewControllerDelegate {
    ...
    func popoverShouldClose(_: BookmarkListViewController) {
        close()
    }
