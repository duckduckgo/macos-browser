...
extension UserText {
    ...
    static let pmDeactivate = NSLocalizedString("pm.deactivate", value: "Deactivate", comment: "Deactivate private email address button")
    static let pmActivate = NSLocalizedString("pm.activate", value: "Activate", comment: "Activate private email address button")
    static let pmEmailMessageInactive = NSLocalizedString("pm.active.email.mesage", value: "Private Duck Address generated by %@. You won't receive emails sent to this address", comment: "Mesasage displayed when a private email address is deactivated")
    static let pmEmailMessageActive = NSLocalizedString("pm.active.email.mesage", value: "Private Duck Address generated by %@. You will receive emails sent to this address", comment: "Mesasage displayed when a private email address is active")
