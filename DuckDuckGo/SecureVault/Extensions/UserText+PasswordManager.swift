...
extension UserText {
    ...
    static let pmEmailActivateConfirmContent = NSLocalizedString("pm.private.email.mesage.activate.confirm.content", value: "You will receive emails sent to this address.", comment: "Text for the confirmation message displayed when a user tries activate a Private Email Address")
    ...
    static let pmEmailDeactivateConfirmContent = NSLocalizedString("pm.private.email.mesage.deactivate.confirm.content", value: "You won’t receive emails sent to this address.", comment: "Text for the confirmation message displayed when a user tries deactivate a Private Email Address")
