...
extension UserText {
    ...
    static let pmEmailActivateConfirmContent = NSLocalizedString("pm.private.email.mesage.activate.confirm.content", value: "Email to %@ will be forwarded to your inbox.", comment: "Text for the confirmation message displayed when a user tries activate a Private Email Address")
    ...
    static let pmEmailDeactivateConfirmContent = NSLocalizedString("pm.private.email.mesage.deactivate.confirm.content", value: "Emails sent to %@ will stop being forwarded to your inbox..", comment: "Text for the confirmation message displayed when a user tries deactivate a Private Email Address")
