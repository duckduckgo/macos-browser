...
extension UserText {
    ...
    static let pmActivateAddress = NSLocalizedString("pm.activate.private.email", value: "Activate Duck Address", comment: "Activate private email address button")
    static let pmDeactivate = NSLocalizedString("pm.deactivate", value: "Deactivate", comment: "Deactivate button")
    static let pmActivate = NSLocalizedString("pm.activate", value: "Activate", comment: "Activate button")
    ...
    static let pmEmailMessageError = NSLocalizedString("pm.private.email.mesage.error", value: "This private email address cannot be managed at this time.", comment: "Mesasage displayed when a user tries to manage a private email address but the service is not available, returns an error or network is down")
    static let pmEmailActivateConfirmTitle = NSLocalizedString("pm.private.email.mesage.activate.confirm.title", value: "Activate this Private Duck Address?.", comment: "Title for the confirmation message  displayed when a user tries activate a Private Email Address")
