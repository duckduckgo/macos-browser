...
struct DataBrokerProtectionAppEvents {
    ...
    func applicationDidFinishLaunching() {
        ...
        Task {
            ...
            if let profileQueriesCount = try? DataBrokerProtectionManager.shared.dataManager.fetchBrokerProfileQueryData(ignoresCache: true),
               profileQueriesCount.count > 0 {
