...
final class BraveDataImporter: ChromiumDataImporter {
    ...
    static func braveAppIcon() -> NSImage? {
        guard let bravePath = NSWorkspace.shared.absolutePathForApplication(withBundleIdentifier: "com.brave.Browser") else {
            return nil
        }

        return NSWorkspace.shared.icon(forFile: bravePath)
    }
