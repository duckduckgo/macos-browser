...
struct NetworkProtectionTermsAndConditionsContentView: View {
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            Text(verbatim: UserText.networkProtectionPrivacyPolicyTitle)
                .font(.system(size: 15, weight: .bold))
                .multilineTextAlignment(.leading)

            Group {
                Text(verbatim: UserText.networkProtectionPrivacyPolicySection1Title).titleStyle()

                if #available(macOS 12.0, *) {
                    Text(verbatim: UserText.networkProtectionPrivacyPolicySection1ListMarkdown).bodyStyle()
                } else {
                    Text(verbatim: UserText.networkProtectionPrivacyPolicySection1ListNonMarkdown).bodyStyle()
                }

                Text(verbatim: UserText.networkProtectionPrivacyPolicySection2Title).titleStyle()
                Text(verbatim: UserText.networkProtectionPrivacyPolicySection2List).bodyStyle()
                Text(verbatim: UserText.networkProtectionPrivacyPolicySection3Title).titleStyle()
                Text(verbatim: UserText.networkProtectionPrivacyPolicySection3List).bodyStyle()
                Text(verbatim: UserText.networkProtectionPrivacyPolicySection4Title).titleStyle()
                Text(verbatim: UserText.networkProtectionPrivacyPolicySection4List).bodyStyle()
                Text(verbatim: UserText.networkProtectionPrivacyPolicySection5Title).titleStyle()
                Text(verbatim: UserText.networkProtectionPrivacyPolicySection5List).bodyStyle()
            }

            Text(verbatim: UserText.networkProtectionTermsOfServiceTitle)
                .font(.system(size: 15, weight: .bold))
                .multilineTextAlignment(.leading)
                .padding(.top, 28)
                .padding(.bottom, 14)
            ...
            Group {
                Text(verbatim: UserText.networkProtectionTermsOfServiceSection1Title).titleStyle(topPadding: 0)
                Text(verbatim: UserText.networkProtectionTermsOfServiceSection1List).bodyStyle()
                Text(verbatim: UserText.networkProtectionTermsOfServiceSection2Title).titleStyle()

                if #available(macOS 12.0, *) {
                    Text(verbatim: UserText.networkProtectionTermsOfServiceSection2ListMarkdown).bodyStyle()
                } else {
                    Text(UserText.networkProtectionTermsOfServiceSection2ListNonMarkdown).bodyStyle()
                }

                Text(verbatim: UserText.networkProtectionTermsOfServiceSection3Title).titleStyle()
                Text(verbatim: UserText.networkProtectionTermsOfServiceSection3List).bodyStyle()
                Text(verbatim: UserText.networkProtectionTermsOfServiceSection4Title).titleStyle()
                Text(verbatim: UserText.networkProtectionTermsOfServiceSection4List).bodyStyle()
                Text(verbatim: UserText.networkProtectionTermsOfServiceSection5Title).titleStyle()
                Text(verbatim: UserText.networkProtectionTermsOfServiceSection5List).bodyStyle()
            }

            Group {
                Text(verbatim: UserText.networkProtectionTermsOfServiceSection6Title).titleStyle()
                Text(verbatim: UserText.networkProtectionTermsOfServiceSection6List).bodyStyle()
                Text(verbatim: UserText.networkProtectionTermsOfServiceSection7Title).titleStyle()
                Text(verbatim: UserText.networkProtectionTermsOfServiceSection7List).bodyStyle()
                Text(verbatim: UserText.networkProtectionTermsOfServiceSection8Title).titleStyle()
                Text(verbatim: UserText.networkProtectionTermsOfServiceSection8List).bodyStyle()
            }
        }
        .padding(.all, 20)
    }
