...
final class SavePaymentMethodViewController: NSViewController {
    ...
    @IBAction
    func onNotNowClicked(sender _: NSButton) {
        delegate?.shouldCloseSavePaymentMethodViewController(self)
    }

    @IBAction
    func onSaveClicked(sender _: NSButton) {
        defer {
    ...
    @IBAction
    func onOpenPreferencesClicked(sender _: NSButton) {
