...
#if DEBUG
        return NSApp.runType.shouldLoadEnvironment ? TabExtensionsBuilder() : TestTabExtensionsBuilder.shared
#else
...
#if DEBUG
        assert(!NSApp.runType.shouldLoadEnvironment || tabExtension != nil)
#else
