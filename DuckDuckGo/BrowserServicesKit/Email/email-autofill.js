 ...
 var AndroidInterface = function AndroidInterface() {
   ...
   this.storeUserData = function (_ref2) {
   ...
   this.attachTooltip = function (form, input) {
 ...
 var AppleDeviceInterface = function AppleDeviceInterface() {
   ...
   this.storeUserData = function (_ref4) {
 ...
 var DeviceInterface = !isDDGApp ? new ExtensionInterface() : isAndroid ? new AndroidInterface() : new AppleDeviceInterface();
