...
var getAttachWebTooltip = function getAttachWebTooltip(getAlias, refreshAlias) {
...
var AppleDeviceInterface = function AppleDeviceInterface() {
  ...
  this.attachTooltip = isMacOSApp ? getAttachWebTooltip(this.getAlias, this.refreshAlias) : function (form, input) {
    form.activeInput = input;
    sendAndWaitForAnswer(function () {
      return window.webkit.messageHandlers['emailHandlerGetAlias'].postMessage({
...
var DeviceInterface = !isDDGApp ? new ExtensionInterface() : isAndroid ? AndroidInterface : new AppleDeviceInterface();
...
var isMacOSApp = false; // INJECT isMacOSApp HERE
