"use strict";
(() => {
  // DuckDuckGo/Youtube Player/Resources/assets/styles.css
  ...
  // DuckDuckGo/Youtube Player/Resources/src/video-player-overlay.js
  var VideoPlayerOverlay = {
  ...
  // DuckDuckGo/Youtube Player/Resources/assets/dax.svg
  ...
  // DuckDuckGo/Youtube Player/Resources/src/icon-overlay.js
  var IconOverlay = {
  ...
  window.enable = function enable(args) {
    console.log("\u{1F474} reading user prefs", args);
    const CSS = {
    ...
    const Site = {
      ...
      init: () => {
        ...
        console.log("\u{1F50D} waiting for video");
        Site.onDOMChanged(() => {
          if (OverlaySettings.enabled.thumbnails) {
            VideoThumbnail.bindEventsToAll();
            Preview.init();
