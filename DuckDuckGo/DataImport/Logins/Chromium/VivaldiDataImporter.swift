...
final class VivaldiDataImporter: ChromiumDataImporter {
    ...
    init(loginImporter: LoginImporter, bookmarkImporter: BookmarkImporter) {
        ...
        let defaultDataURL = applicationSupport.appendingPathComponent("Vivaldi/Default/")
