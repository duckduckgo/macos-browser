...
final class CoccocDataImporter: ChromiumDataImporter {
    ...
    init(loginImporter: LoginImporter, bookmarkImporter: BookmarkImporter) {
        ...
        let defaultDataURL = applicationSupport.appendingPathComponent("Coccoc/Default/")
