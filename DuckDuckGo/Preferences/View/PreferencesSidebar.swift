            ...
            Group {
                if let name = section.displayName {
                    Text(name)
                        ...
                        .padding(.bottom, 3)
                        .font(PreferencesUI.Const.Fonts.sideBarHeader)
        ...
        var body: some View {
            Button(action: action) {
                HStack(spacing: 6) {
                    ...
                    Text(pane.displayName).font(PreferencesUI.Const.Fonts.sideBarItem)
    ...
    struct TabSwitcher: View {
        ...
        var body: some View {
            NSPopUpButtonView(selection: $model.selectedTabIndex, viewCreator: {
                ...
                button.font = PreferencesUI.Const.Fonts.popUpButton
