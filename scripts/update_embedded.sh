...
TDS_URL="https://staticcdn.duckduckgo.com/trackerblocking/v500/current/macos-tds.json"
CONFIG_URL="https://staticcdn.duckduckgo.com/trackerblocking/config/v300/macos-config.json"
