...
struct Arguments {
    ...
    init(args: [String]) throws {
        ...
        for i in stride(from: 0, to: remainingArgs.count, by: 2) {
            parameters[remainingArgs[i]] = remainingArgs[i+1]
        }
...
// MARK: - Generating of new appcast and delta file
...
func handleReleaseNotesFile(path: String, updatesDirectoryURL: URL, dmgURL: URL) -> Void {
