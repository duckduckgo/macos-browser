...
class HistoryTabExtensionTests: XCTestCase {
    ...
    func testWhenBurnerTab_ThenNoHistoryIsStored() {
        ...
        let historyTabExtension = HistoryTabExtension(isBurner: true, historyCoordinating: historyCoordinatingMock, trackersPublisher: trackersPublisher, urlPublisher: urlPublisher, titlePublisher: titlePublisher, phishingStateManager: PhishingTabStateManager())
