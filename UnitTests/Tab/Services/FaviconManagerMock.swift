...
final class FaviconManagerMock: FaviconManagement {
    ...
    func burnDomains(_ domains: Set<String>, exceptBookmarks bookmarkManager: DuckDuckGo_Privacy_Browser.BookmarkManager, exceptSavedLogins: Set<String>, exceptExistingHistory history: BrowsingHistory, tld: Common.TLD, completion: @escaping @MainActor () -> Void) {
        completion()
    }
}
