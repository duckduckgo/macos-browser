...
final class UserText {
    ...
    static let vpnDnsServer = NSLocalizedString("network.protection.vpn.dns-server", value: "DNS Server", comment: "Title for the DNS server section in the VPN status view")
    ...
    static let vpnSendFeedback = NSLocalizedString("network.protection.vpn.send-feedback", value: "Send Feedback…", comment: "Action button title for the Send feedback option")
    static let vpnOperationNotPermittedMessage = NSLocalizedString("network.protection.vpn.failure.operation-not-permitted", value: "Unable to connect due to an unexpected error. Restarting your Mac can usually fix the issue.", comment: "Error message for the Operation not permitted error")
    ...
    static let networkProtectionOnboardingAllowExtensionDescSuffixForSequoia = NSLocalizedString("network.protection.onboarding.allow.extension.desc.sequoia.suffix", value: " to allow DuckDuckGo VPN's Network Extension", comment: "Non-bold description for the onboarding allow-extension description")
