...
final class UserText {
    ...
    static let vpnShareFeedback = NSLocalizedString("network.protection.vpn.share-feedback", value: "Share Feedback…", comment: "Action button title for the Share feedback option")
