...
final class UserText {
    ...
    static let vpnSendFeedbackMenuItemTitle = NSLocalizedString("vpn.send-feedback.menu.item.title", bundle: Bundle.module, value: "Send Feedback", comment: "The VPN status view's 'Send Feedback' menu item for our status bar app")
