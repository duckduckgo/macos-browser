...
enum UserText {
    ...
    static func activateModalDescription(platform: SubscriptionEnvironment.Platform) -> String {
        switch platform {
        case .appStore:
    ...
    static func shareModalDescription(platform: SubscriptionEnvironment.Platform) -> String {
        switch platform {
        case .appStore:
