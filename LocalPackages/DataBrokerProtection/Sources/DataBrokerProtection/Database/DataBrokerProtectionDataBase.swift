...
protocol DataBrokerProtectionRepository {
    func save(_ profile: DataBrokerProtectionProfile) // Is save the most representative name?
    ...
    func brokerProfileQueryData(for brokerId: Int64, and profileQueryId: Int64) -> BrokerProfileQueryData? {
        do {
            ...
            if let broker = try vault.fetchBroker(with: brokerId),
                ...
                // models he was looking for where not found. This will be worked on the error handling task
                return nil
            }
        } catch {
