...
extension DBPUIDataBrokerProfileMatch {
    ...
    init(optOutJobData: OptOutJobData, dataBroker: DataBroker, parentBrokerOptOutJobData: [OptOutJobData]?, optOutUrl: String, optOutBrokerName: String) {
