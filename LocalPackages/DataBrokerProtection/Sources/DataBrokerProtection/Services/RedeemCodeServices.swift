...
public protocol RedeemUseCaseProtocol {
...
public final class RedeemUseCase: RedeemUseCaseProtocol {
    private let authenticationService: AuthenticationServiceProtocol
    private let authenticationRepository: AuthenticationRepository

    public init(authenticationService: AuthenticationServiceProtocol = AuthenticationService(),
